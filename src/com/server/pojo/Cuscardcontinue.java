...
public class Cuscardcontinue
{
    ...
    * 卡总次数
    */
   private int cuscardnums;   
   /**
    * 卡余次
    */
   private int cuscardtimes;   
   /**
    * 卡新余额
    */
   private String cuscardmoneynew;   
   /**
    * 卡新总次数
    */
   private int cuscardnumsnew;   
   /**
    * 卡新余次
    */
   private int cuscardtimesnew;   
   /**
    * 卡积分
    */
   private int cuscardint;   
   /**
    * 备注
    */
   ...
   private String creator;   
	 ...
	 */
	public void setCuscardnums(int cuscardnums)
	{
	 ...
	 */
	public void setCuscardtimes(int cuscardtimes)
	{
	...
	/**
	 *设置"卡新余额"属性
	 *@param cuscardmoneynew 实体的Cuscardmoneynew属性
	 */
	public void setCuscardmoneynew(String cuscardmoneynew)
	{
		this.cuscardmoneynew = cuscardmoneynew;
	}
	
	/**
	 *获取"卡新余额"属性
	 */
	public String getCuscardmoneynew()
	{
		return this.cuscardmoneynew;
	}	   

	/**
	 *设置"卡新总次数"属性
	 *@param cuscardnumsnew 实体的Cuscardnumsnew属性
	 */
	public void setCuscardnumsnew(int cuscardnumsnew)
	{
		this.cuscardnumsnew = cuscardnumsnew;
	}
	
	/**
	 *获取"卡新总次数"属性
	 */
	public int getCuscardnumsnew()
	{
		return this.cuscardnumsnew;
	}	   

	/**
	 *设置"卡新余次"属性
	 *@param cuscardtimesnew 实体的Cuscardtimesnew属性
	 */
	public void setCuscardtimesnew(int cuscardtimesnew)
	{
		this.cuscardtimesnew = cuscardtimesnew;
	}
	
	/**
	 *获取"卡新余次"属性
	 */
	public int getCuscardtimesnew()
	{
		return this.cuscardtimesnew;
	}	   
	 ...
	 */
	public void setCuscardint(int cuscardint)
	{
