...
public class Cuscarduser
{
    ...
    * 新会员ID
    */
   private String cuscardcustomernew;   
   /**
    * 分类
    */
   ...
   private String creator;   
	...
	/**
	 *设置"新会员ID"属性
	 *@param cuscardcustomernew 实体的Cuscardcustomernew属性
	 */
	public void setCuscardcustomernew(String cuscardcustomernew)
	{
		this.cuscardcustomernew = cuscardcustomernew;
	}
	
	/**
	 *获取"新会员ID"属性
	 */
	public String getCuscardcustomernew()
	{
		return this.cuscardcustomernew;
	}	   
