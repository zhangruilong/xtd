Ext.onReady(function() {
	...
	var Placefields = ['placeid'
		...
		var Placestore = dataStore(Placefields, basePath + "PlaceviewAction.do?method=selQueryyouyong");// 定义Placestore
	...
	var Placegrid = new Ext.grid.GridPanel({
		...
		tbar : [{
				...
				handler : function() {
					...
					PlacedataForm.getForm().setValues({Placeplaceproject:'游泳'});
				}
			},'-',{
				text : "修改",
				iconCls : 'edit',
