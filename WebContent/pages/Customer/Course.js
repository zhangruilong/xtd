function selectCourse(customerid,mycourseid,mycoursename,mycoursenum,coachid,coachname,projectname) {	
		...
		buttons : [
					{
						...
						handler : function() {
							...
							var json = "[{'mycourseid':'"+mycourseid
		        			    +"','mycoursenum':'"+(mycoursenum-1)
		        			    +"'}]";
							Ext.Ajax.request({
								url : basePath + "MycourseAction.do?method=updAll",
								method : 'POST',
								params : {
									json : json
								},
