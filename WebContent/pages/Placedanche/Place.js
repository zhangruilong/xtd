Ext.onReady(function() {
	...
	var Placestore = dataStore(Placefields, basePath + "PlaceviewAction.do?method=selQuerydanche");// 定义Placestore
	...
	var Placegrid = new Ext.grid.GridPanel({
		...
		tbar : [{
				...
				handler : function() {
					...
					PlacedataForm.getForm().setValues({Placeplaceproject:'单车'});
				}
			},'-',{
				text : "修改",
				iconCls : 'edit',
