...
<aa:http id="getAddress" url="http://p9line/flow.php?step=consignee"></aa:http>
<%
...
%>
<aa:for-each var="i" xpath="//div[@class='flowBox']" dsId="getAddress">
<%
JSONObject detail = new JSONObject();
%>
<aa:for-each var="j" xpath=".//input[not(@type='button' or @type='submit')]" dsId="i">
<%
detail.put(aa.xpath.xpath("./@name", "j"), aa.xpath.copyOfNodeAsStr(".", "j").replaceAll("onclick=\"[^\"]*\"", ""));
%>
</aa:for-each>
<aa:for-each var="k" xpath=".//select" dsId="i">
<%
detail.put(aa.xpath.xpath("./@name", "k"), aa.xpath.copyOfNodeAsStr(".", "k").replaceAll("onclick=\"[^\"]*\"", ""));
%>
</aa:for-each>
<%
